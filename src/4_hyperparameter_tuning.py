...
def hyperparameter_tuning(train_loader, valid_loader, test_loader):
...
if __name__=='__main__':
  ...
  tuning_result_df = hyperparameter_tuning(train_loader, valid_loader, test_loader)
  print(tuning_result_df)
